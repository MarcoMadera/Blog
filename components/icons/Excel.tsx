...
export function Excel(props: SVGProps<SVGSVGElement>): ReactElement {
  return (
    <svg viewBox="0 0 110.037 107.5" {...props}>
      <title>Excel</title>
      <path
