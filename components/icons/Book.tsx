...
export function Book(props: SVGProps<SVGSVGElement>): ReactElement {
  ...
  return (
    <svg viewBox="0 0 512 512" {...props}>
      ...
      <path
        fill={colors.white}
        d="M39.803 83.847H472.19v312.284H39.803z"
      ></path>
      <path
      ...
      <path
        fill={colors.rangoonGreen}
        d="M328.068 244.22h104.091v15.556H328.068z"
      ></path>
      <path
        fill={darkMode ? colors.lavaRed : colors.redBerry}
      ...
      <path
        fill={colors.rangoonGreen}
        d="M328.068 276.245h104.091v15.556H328.068z"
      ></path>
      <path
        fill={darkMode ? colors.lavaRed : colors.redBerry}
      ...
      <path
        fill={colors.rangoonGreen}
        d="M328.068 308.28h104.091v15.556H328.068z"
      ></path>
      <path
        fill={darkMode ? colors.lavaRed : colors.redBerry}
      ...
      <path
        fill={colors.rangoonGreen}
        d="M328.068 340.305h104.091v15.556H328.068z"
      ></path>
    </svg>
  );
}
