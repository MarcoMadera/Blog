...
export default function Privacy() {
  ...
  return (
    <main id="main">
      ...
      <address>
        Titular: Marco Antonio Madera.
        <br />
        Correo electrónico:{" "}
        <A
          href="mailto:marcomaderaa@gmail.com"
          target="_blank"
          rel="noopener noreferer"
        >
          marcomaderaa@gmail.com
        </A>
        <br />
      ...
      <P>
        ...
        no es necesario que facilites ningún dato personal. Los casos en los que
        sí proporcionas tus datos personales son los siguientes:
      </P>
      <Ul>
        <Li>
      ...
      <P>
        ...
        reclamación ante una autoridad de control si consideras que el
        tratamiento de datos personales que te conciernen infringe el
        Reglamento.
      </P>
      ...
      <P>
        ...
        información de carácter personal de la que el responsable es el Titular.
        Esta información puede incluir datos de carácter personal como pueden
        ser tu dirección IP, nombre y apellidos, dirección física, dirección de
        correo electrónico, número de teléfono, y otra información. Al facilitar
        esta información, das tu consentimiento para que tu información sea
      ...
      <Ul>
        ...
        <Li>
          ...
          <Ul>
            <Li>
              <A href="https://twitter.com/en/privacy">Twitter</A>
            </Li>
            <Li>
      ...
      <P>
        ...
        . La seguridad de tus datos está garantizada, ya que toman todas las
      ...
      <P>
        ...
        puedes consultar toda la información relativa a la política de recogida,
        la finalidad y el tratamiento de las cookies.
      </P>
      ...
      <Ul>
        ...
        <Li>Conservación de datos personales</Li>
        <Li>
      ...
      <P>
        ...
        se pueden recoger datos no identificativos, que pueden incluir, la
        dirección IP, geolocalización, un registro de cómo se utilizan los
        servicios y sitios, hábitos de navegación y otros datos que no pueden
