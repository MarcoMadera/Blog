...
<pre><code className="preCode"><span class="codeGreen">?</span> What account do you want to log into? <span class="codeBlue">GitHub.com</span>
...
<pre><code className="preCode">C:\Users\marco\repositorios>gh repo create github-cli
...
<pre><code className="preCode">C:\Users\marco\repositorios\github-cli>gh repo view
...
<span class="codeGray">No description provided</span>
  ...
  <span class="boldBlue">### Ver los repositorios</span>
    ...
    $gh repo view <span class="codeRed">[</span>< repository ><span class="codeRed">]</span>
...
<pre><code className="preCode">C:\Users\marco\repositorios>gh repo clone github-cli
...
<pre><code className="preCode">C:\Users\marco\repositorios>gh pr create --title "Como crear un pr" --body "contenido"
...
<pre><code className="preCode">C:\Users\marco\repositorios>gh pr view
...
<pre><code className="preCode">C:\Users\marco\repositorios>gh issue create --title "titulo" --body "contenido" --label "bug"
...
<pre><code className="preCode">C:\Users\marco\repositorios>gh issue list --label "bug"
...
<pre><code className="preCode">C:\Users\marco\repositorios>gh alias set cr "repo create"
...
<pre><code className="preCode">C:\Users\marco>gh api https://marcomadera.com/api/now-playing
{
  ...
  <span class="codeBlue">"cover"</span>: <span class="codeGreen">""https://i.scdn.com/image/ab67616d00004851c27ad6f390a857177ba33dc"</span>,
